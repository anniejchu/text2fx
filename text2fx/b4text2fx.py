...
def text2fx2(
    ...
    # embedding_target = projector(torch.sigmoid(embedding_target.to(device)))
    ...
    for n in pbar:
        ...
        # #NOTE: JUST FOR TROUBLESHOOTING B4.PROJECTOR RUNS BEFORE 8/23, MIGHTVE TRAINED IT W SIGMOID
        # print('sigmoiding')
        # embedding_effected = projector(torch.sigmoid(embedding_effected.to(device)))
